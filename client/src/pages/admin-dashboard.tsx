                                ...
                                <Dialog>
                                  ...
                                  <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
                                    <DialogHeader>
                                      ...
                                      <DialogDescription>
                                        Complete information for application #{application.id.slice(0, 8)}
                                      </DialogDescription>
                                    </DialogHeader>
                                      ...
                                      <Card>
                                        ...
                                        <CardContent className="space-y-3">
                                          ...
                                          <div>
                                            ...
                                            <p className="text-sm text-gray-900 font-mono">{application.userId}</p>
                                          </div>
                                          <div>
                                      ...
                                      <Card>
                                        ...
                                        <CardContent className="space-y-3">
                                          <div>
                                            ...
                                            <p className="text-sm text-gray-900 font-medium">{application.program?.title}</p>
                                          </div>
                                          <div>
                                          ...
                                          <div>
                                            ...
                                            <p className="text-sm text-gray-900">{application.program?.hospitalName}</p>
                                          </div>
                                          <div>
                                            <label className="text-sm font-medium text-gray-600">Mentor</label>
                                            <p className="text-sm text-gray-900">{application.program?.mentorName}</p>
                                          </div>
                                        ...
                                        <CardContent className="space-y-3">
                                          ...
                                          {application.joinDate && (
                                            <div>
                                              ...
                                              <p className="text-sm text-gray-900">
                                                {new Date(application.joinDate).toLocaleDateString()}
                                              </p>
                                            </div>
                                          )}
                                          <div>
